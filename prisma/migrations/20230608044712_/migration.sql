...
-- CreateEnum
CREATE TYPE "DocumentType" AS ENUM ('INTRODUCTION', 'CURRICULUM', 'SUBTITLE', 'DOC', 'QUIZ', 'ATTACHMENT');

-- CreateEnum
CREATE TYPE "DocumentState" AS ENUM ('OPEN', 'REVIEW', 'COMPLETE');
...
-- AddForeignKey
ALTER TABLE "ProjectsOfUsers" ADD CONSTRAINT "ProjectsOfUsers_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProjectsOfUsers" ADD CONSTRAINT "ProjectsOfUsers_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
